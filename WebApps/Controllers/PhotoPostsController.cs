...
namespace WebApps.Controllers
{
    public class PhotoPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Filename,Caption,PostId,Username,Unlikes,likes")] PhotoPost photoPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Filename,Caption,PostId,Username,Unlikes,likes")] PhotoPost photoPost)
        {
